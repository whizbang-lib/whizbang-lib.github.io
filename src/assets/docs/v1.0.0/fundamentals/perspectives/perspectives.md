...
## Pure Function Pattern {#pure-services}
...
```sql{title="Denormalization" description="Write Model (normalized):" category="Architecture" difficulty="INTERMEDIATE" tags=["Fundamentals", "Perspectives", "Denormalization"]}
...
```sql{title="Denormalization (2)" description="Read Model (denormalized):" category="Architecture" difficulty="INTERMEDIATE" tags=["Fundamentals", "Perspectives", "Denormalization"]}
...
**Query Performance**:
```sql{title="Denormalization (3)" description="Query Performance:" category="Architecture" difficulty="INTERMEDIATE" tags=["Fundamentals", "Perspectives", "Denormalization"]}
