...
```csharp{title="Generated Code Example" description="Source generators produce registration code:" category="Implementation" difficulty="INTERMEDIATE" tags=["Fundamentals", "Identity", "Generated", "Code"] unverified="illustrative source-generator output — a generated ModuleInitializer registration template (MyApp.Contracts.Generated), not a verifiable unit behavior"}
...
```csharp{title="StreamIdExtractorRegistry" description="StreamIdExtractorRegistry" category="Implementation" difficulty="BEGINNER" tags=["Fundamentals", "Identity", "StreamIdExtractorRegistry"] unverified="StreamIdExtractorRegistry usage snippet — StreamIdExtractorRegistryTests cover GetGenerationPolicy/SetStreamId/GetComposite delegation, not the Register-plus-ExtractStreamId lookup shown here"}
