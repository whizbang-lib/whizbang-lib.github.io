...
```csharp{title="Basic Command Endpoint" description="Demonstrates basic Command Endpoint" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "Basic", "Command"]}
...
```csharp{title="With HTTP Method" description="Demonstrates with HTTP Method" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "HTTP", "Method"]}
...
```csharp{title="Delete Operation" description="Demonstrates delete Operation" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "Delete", "Operation"]}
...
```csharp{title="Command Definition" description="Demonstrates command Definition" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "Command", "Definition"]}
...
```csharp{title="Generated Endpoint (Simplified)" description="Demonstrates generated Endpoint (Simplified)" category="API" difficulty="INTERMEDIATE" tags=["Apis", "Rest", "Generated", "Endpoint"]}
...
```csharp{title="Custom Extension" description="Demonstrates custom Extension" category="API" difficulty="ADVANCED" tags=["Apis", "Rest", "Custom", "Extension"]}
...
**Response:**
```json{title="Create Order" description="Demonstrates create Order" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "Create", "Order"]}
{
...
```csharp{title="FluentValidation" description="Demonstrates fluentValidation" category="API" difficulty="BEGINNER" tags=["Apis", "Rest", "FluentValidation"]}
...
```csharp{title="In Hook" description="Demonstrates in Hook" category="API" difficulty="ADVANCED" tags=["Apis", "Rest", "Hook"]}
protected override async ValueTask OnBeforeExecuteAsync(
    CreateOrderCommand command,
    IMutationContext context,
    CancellationToken ct) {
