...
internal sealed record InheritanceInfo(
    ...
    string BaseTypeName,     // e.g., "global::MyApp.BaseConsumerEvent"
...
internal sealed record PolymorphicTypeInfo(
    string BaseTypeName,                    // "global::MyApp.BaseConsumerEvent"
    string BaseSimpleName,                  // "BaseConsumerEvent"
...
Example:
```
info WHIZ071: Discovered polymorphic base type 'BaseConsumerEvent' with 3 derived type(s)
