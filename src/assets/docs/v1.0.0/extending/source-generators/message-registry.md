...
**Visual Example**:
```csharp{title="IDE Features Enabled" description="Visual Example:" category="Internals" difficulty="BEGINNER" tags=["Extending", "Source-Generators", "IDE", "Features"] unverified="illustration — editor CodeLens rendering, not compilable code"}
// In your code editor:
...
```mermaid{caption="Message-registry generation flow — the Roslyn generator discovers messages, dispatchers, receptors, and perspectives, emits MessageRegistry.g.cs with embedded JSON, and a shipped MSBuild target extracts it to .whizbang/cache/message-registry.json." tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_NoCompilationErrors_GeneratesValidCodeAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithDispatcher_DiscoversDispatcherAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithReceptor_DiscoversReceptorAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_EventWithPerspective_DiscoversPerspectiveAsync"]}
flowchart TD
...
```csharp{title="Generated File" description="**MessageRegistry." category="Internals" difficulty="ADVANCED" tags=["Extending", "Source-Generators", "Generated", "File"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_GeneratedJson_ContainsFilePathsAndLineNumbersAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_SingleCommand_DiscoversCommandAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithDispatcher_DiscoversDispatcherAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithReceptor_DiscoversReceptorAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_EventWithPerspective_DiscoversPerspectiveAsync"]}
// <auto-generated/>
...
```csharp{title="Pattern 1: Message Discovery" description="Discovers ICommand and IEvent implementations:" category="Internals" difficulty="INTERMEDIATE" tags=["Extending", "Source-Generators", "Pattern", "Message"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_SingleCommand_DiscoversCommandAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_SingleEvent_DiscoversEventAsync"]}
// Command
...
```csharp{title="Pattern 2: Dispatcher Discovery" description="Discovers SendAsync and PublishAsync call sites:" category="Internals" difficulty="INTERMEDIATE" tags=["Extending", "Source-Generators", "Pattern", "Dispatcher"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithDispatcher_DiscoversDispatcherAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_NonDispatcherSendAsyncOnUnrelatedType_DoesNotRegisterAsync"]}
...
```csharp{title="Pattern 2: Dispatcher Discovery (2)" description="Also discovers PublishAsync:" category="Internals" difficulty="BEGINNER" tags=["Extending", "Source-Generators", "Pattern", "Dispatcher"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_PublishAsyncWithGeneric_DiscoversDispatcherAsync"]}
...
```csharp{title="Pattern 3: Receptor Discovery" description="Discovers IReceptor<TMessage, TResponse> implementations:" category="Internals" difficulty="BEGINNER" tags=["Extending", "Source-Generators", "Pattern", "Receptor"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_CommandWithReceptor_DiscoversReceptorAsync"]}
...
```csharp{title="Pattern 4: Perspective Discovery" description="Discovers IPerspectiveFor<TModel, TEvent...> implementations:" category="Internals" difficulty="INTERMEDIATE" tags=["Extending", "Source-Generators", "Pattern", "Perspective"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_PerspectiveWithMultipleEvents_DiscoversAllEventsAsync", "MessageRegistryGeneratorTests.MessageRegistryGenerator_EventWithPerspectiveWithActionsFor_DiscoversPerspectiveAsync"]}
...
```csharp{title="Multi-Pipeline Architecture" description="Generator uses 4 independent pipelines for optimal caching:" category="Internals" difficulty="INTERMEDIATE" tags=["Extending", "Source-Generators", "Multi-Pipeline", "Architecture"] unverified="generator-internal pipeline implementation — source-gen tests assert generated output, not the generator's internal pipeline structure"}
// Pipeline 1: Messages
...
```csharp{title="Cross-Assembly Messages" description="Generator handles messages from referenced assemblies:" category="Internals" difficulty="BEGINNER" tags=["Extending", "Source-Generators", "Cross-Assembly", "Messages"] tests=["MessageRegistryGeneratorTests.MessageRegistryGenerator_ReferencedAssemblyMessage_InfersTypeAsync"]}
