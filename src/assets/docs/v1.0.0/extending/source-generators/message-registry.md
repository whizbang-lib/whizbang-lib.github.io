...
```csharp{title="Pattern 4: Perspective Discovery" description="Discovers IPerspectiveOf<TEvent> implementations:" category="Internals" difficulty="INTERMEDIATE" tags=["Extending", "Source-Generators", "Pattern", "Perspective"]}
...
```xml{title="MSBuild Target" description="Generator runs automatically during build." category="Internals" difficulty="BEGINNER" tags=["Extending", "Source-Generators", "MSBuild", "Target"]}
<!-- MyApp.csproj -->
