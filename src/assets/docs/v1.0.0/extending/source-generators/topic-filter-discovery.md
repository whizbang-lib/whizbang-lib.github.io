...
order: 6
description: >-
  Compile-time topic filter discovery with Roslyn source generators - type-safe,
  zero-reflection message routing configuration
tags: >-
  source-generators, topic-filters, roslyn, compile-time, zero-reflection, aot,
  routing
codeReferences:
