...
```csharp{title="Solution: Use Source-Generated Registration" description="Generated DispatcherRegistrations extensions register everything" category="Configuration" difficulty="BEGINNER" tags=["Operations", "Deployment", "Solution", "Source-Generated"]}
...
```csharp{title="Solution 1: Whizbang Workers Not Wired" description="AddWhizbang + storage driver registers the outbox pipeline" category="Configuration" difficulty="BEGINNER" tags=["Operations", "Deployment", "Solution", "Outbox"]}
builder.Services
...
```csharp{title="Solution 2: Transport Diagnosis" description="Trace the outbox path" category="Configuration" difficulty="INTERMEDIATE" tags=["Operations", "Deployment", "Solution", "Transport"]}
...
```csharp{title="Solution 1: Retry-Aware Receptor" description="Skip retries using ILifecycleContext.AttemptNumber" category="Configuration" difficulty="INTERMEDIATE" tags=["Operations", "Deployment", "Solution", "Inbox"]}
...
```csharp{title="Solution 2: Service Bus PeekLock Not Used" description="Fix: Use PeekLock mode (at-least-once delivery):" category="Configuration" difficulty="BEGINNER" tags=["Operations", "Deployment", "Solution", "Service"]}
...
```csharp{title="Solution 2: N+1 Query Problem (2)" description="Fix: Use JOIN or batch query:" category="Configuration" difficulty="INTERMEDIATE" tags=["Operations", "Deployment", "Solution", "N+1"]}
