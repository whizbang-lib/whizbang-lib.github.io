...
order: 1
description: >-
  Cloud-native orchestration for Whizbang applications with .NET Aspire -
  automatic infrastructure provisioning and service discovery
tags: >-
  aspire, cloud-native, orchestration, service-bus, emulator, infrastructure,
...
**AppHost Project**:
```bash{title="Add Whizbang NuGet Packages" description="AppHost Project:" category="Configuration" difficulty="BEGINNER" tags=["Operations", "Infrastructure", "Add", "Whizbang"]}
