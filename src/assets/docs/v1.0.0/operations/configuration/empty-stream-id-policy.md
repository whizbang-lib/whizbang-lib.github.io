...
Whizbang.Core.Messaging.EmptyStreamIdException: Producer attempted to write
  a consumer.Contracts.Auth.RemoveShellUserCommand (message_id=019e92b2-1bbb-708d-...)
...
Three independent surfaces close the production silent-stuck pattern:
...
### production-style stuck rows already in the table
