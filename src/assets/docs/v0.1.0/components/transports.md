...
category: Components
order: 9
evolves-to: v0.2.0/enhancements/transports.md, v0.3.0/features/transports.md, v0.5.0/production/transports.md
...
[See HTTP features →](../../v0.2.0/enhancements/transports.md)
:::
...
Transports provide the communication layer in Whizbang, enabling message exchange between components. In v0.1.0, we provide a simple in-process transport that passes messages directly in memory - perfect for monolithic applications and testing.
...
:::new
The default in-process transport for v0.1.0:
:::
...
:::new
Simple message pipeline for v0.1.0:
:::
