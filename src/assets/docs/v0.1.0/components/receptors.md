...
category: Components
order: 3
evolves-to: v0.2.0/enhancements/receptors.md, v0.3.0/features/stateful-receptors.md
...
[See planned enhancements →](../../v0.2.0/enhancements/receptors.md)
:::
...
[See temporal features →](../../v0.3.0/features/temporal-receptors.md)
:::
...
Receptors are the decision-making components in Whizbang. They receive commands, apply business rules, and emit events representing the decisions made. In v0.1.0, receptors are **stateless** and focus on simple command-to-event transformation.
