...
- [TypeQualification](/v0.1.0/core-concepts/type-qualification) - Flag enum controlling formatting
- [MatchStrictness](/v0.1.0/core-concepts/fuzzy-matching) - Fuzzy matching with formatted types
- [TypeMatcher](/v0.1.0/core-concepts/type-matching) - Matching formatted type strings
- [Perspectives](/v0.1.0/core-concepts/perspectives) - Message associations using formatted types
