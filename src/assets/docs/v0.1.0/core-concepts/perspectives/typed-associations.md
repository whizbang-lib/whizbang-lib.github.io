...
- [PerspectiveAssociationInfo](/v0.1.0/core-concepts/perspectives/association-info) - Association record with delegates
- [Perspectives](/v0.1.0/core-concepts/perspectives) - Overview of perspective system
- [Message Associations](/v0.1.0/core-concepts/perspectives#message-associations) - String-based discovery
