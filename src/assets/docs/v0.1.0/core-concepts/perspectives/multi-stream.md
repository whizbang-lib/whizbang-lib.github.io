...
Multi-stream perspectives can handle up to 3 event types (v0.1.0):
...
**Note**: Maximum 3 event types per perspective in v0.1.0. For more events, create multiple perspectives targeting the same model.
...
4. **No built-in UI for v0.1.0** (manual perspective registration)
...
*Version 0.1.0 - Foundation Release | Last Updated: 2025-12-22*
