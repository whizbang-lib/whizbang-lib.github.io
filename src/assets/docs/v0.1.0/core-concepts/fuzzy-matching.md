...
- [TypeQualification](/v0.1.0/core-concepts/type-qualification) - Formatting types for matching
- [TypeFormatter](/v0.1.0/core-concepts/type-formatting) - Formatting Type objects to strings
- [TypeMatcher](/v0.1.0/core-concepts/type-matching) - Type matching with MatchStrictness
- [Perspectives](/v0.1.0/core-concepts/perspectives) - Message associations using fuzzy matching
