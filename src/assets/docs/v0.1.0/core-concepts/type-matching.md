...
- [TypeQualification](/v0.1.0/core-concepts/type-qualification) - Type name formatting flags
- [TypeFormatter](/v0.1.0/core-concepts/type-formatting) - Format types for matching
- [MatchStrictness](/v0.1.0/core-concepts/fuzzy-matching) - Fuzzy matching control
- [Perspectives](/v0.1.0/core-concepts/perspectives) - Message associations using TypeMatcher
